...
<html>
  <head>
    ...
    <div class="container">
      ...
      <header class="row">
        <div class="col-lg-12">
          <img src="/images/plume.jpg" class="img-rounded" alt="Plume"><div class="text-center font-italic font-weight-bold"><h1 class="title"><a href="/">Billet simple pour l'Alaska</a></h1></div>
        </div>
        <div class="col-lg-12">
